use super::{
    ...
    media_workflow, page, parse_id, pod_result, read_portable_package_directory, resolve_pod,
    CliResult,
};
use crate::parser::{
...
fn execute_content(command: ContentWorkflow, tools: &AgentTools, actor: &AuthContext) -> CliResult {
    match command {
        ...
        ContentWorkflow::Cover(args) => media_workflow::content_cover(&args, tools, actor),
        ContentWorkflow::Snapshot(args) => media_workflow::content_snapshot(&args, tools, actor),
